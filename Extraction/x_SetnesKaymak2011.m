...
function coordinates = x_SetnesKaymak2011(Input,year)
...
ax99.Position = [12.6647 6.2442 31.7500 18.3444];
ax99.PaperSize = [20 15]; % L x H

clear CaseNr NumberOfNaNs PercentageOfNaNs

print(['PatientsVSNaNs',num2str(year),'Yr'],'-dpdf', '-fillpage');
print(['PatientsVSNaNs',num2str(year),'Yr'],'-deps','-tiff');
...
ax100.PaperSize = [20 15]; % L x H

clear x i j VariableName NumberOfNaNs PercentageOfNaNs

% print(['VariablesVSNaNs',num2str(year),'Yr'],'-dpdf', '-fillpage');
% print(['VariablesVSNaNs',num2str(year),'Yr'],'-deps','-tiff');
...
ax1=gca;
ax1.FontSize = 18;
xlabel('Number of missing data allowed in feature','FontSize',30,'FontWeight','bold')
...
fig.Position = [12.6647 6.2442 27 20];
fig.PaperSize = [20 15]; % L x H

print(['OptNumbPatients',num2str(year)], '-deps','-tiff')
print(['OptNumbPatientsC',num2str(year)], '-depsc','-tiff')
print(['OptNumbPatients',num2str(year)], '-dpdf', '-fillpage')
