function [cvp1,data_train,data_test,cvp2,Options] = getDataset(Options)
...
if Options.year == 1
    ...
    if Options.WL == true
       load('Classifiers2020+-3months.mat', 'Classifiers1yr')
       data_table.TWL = [];
       data_table_2 = Classifiers1yr;
    ...
    if Options.EBWL == true
       load('Classifiers2020+-3months.mat', 'Classifiers2yr')
       data_table.TWL = [];
